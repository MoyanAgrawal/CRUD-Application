...
const bodyParser=require('body-parser')  //body parser -> jo data aata h vo header k through aata h

require("./dbConnect")
const app = express();
const encoder=bodyParser.urlencoded()
app.set("views","./views")
app.set("view engine","hbs")    //view engine or template is same thing of express
const partialPath=path.join(__dirname,"./views/partials")    //__dirname -> jis directory ya folder m hum h 
hbs.registerPartials(partialPath)                           //registerPartials -> to register file
